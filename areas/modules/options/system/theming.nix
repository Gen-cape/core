# Colorscheme
{
  ...
  # Get the colors file
  getColorsFile = slug:
    if builtins.pathExists ../../../theming/themes/${slug}/${slug}.yaml
    then ../../../theming/themes/${slug}/${slug}.yaml
    else ../../../theming/themes/catppuccin-mocha/catppuccin-mocha.yaml;
  ...
  wallpaperUrl =
    if builtins.pathExists ../../themes/${slug}/backgroundurl.txt
  ...
  wallpaperSha256 =
    if builtins.pathExists ../../themes/${slug}/backgroundsha256.txt
