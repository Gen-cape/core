...
in {
  ...
  in ''
    ...
    bind=SUPER,C,exec,if hyprctl clients | grep scratch_term; then echo "scratch_term respawn not needed"; else alacritty --class scratch_term; fi
    bind=SUPER,C,togglespecialworkspace,scratch_term
