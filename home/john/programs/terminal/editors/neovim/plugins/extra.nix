{
  ...
  inherit (pkgs.vimPlugins) friendly-snippets aerial-nvim nvim-surround undotree mkdir-nvim ssr-nvim direnv-vim legendary-nvim vim-be-good rainbow-delimiters-nvim oil-nvim otter-nvim;
